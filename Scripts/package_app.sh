...
APP_FINAL="$ROOT/ClCoBar.app"
APP_STAGE="$ROOT/.build/package/ClCoBar.app"
rm -rf "$APP_STAGE"
APP="$APP_STAGE"
...
<plist version="1.0">
<dict>
    <key>CFBundleName</key><string>ClCoBar</string>
    <key>CFBundleDisplayName</key><string>ClCoBar</string>
